    ...
    <section className="panel flex min-h-0 flex-col p-3">
      ...
      {transcript.source !== "whisper" && (
        <p className="mb-2 rounded-md border border-brand-yellow/30 bg-brand-yellow/10 p-2 text-[11px] leading-relaxed text-brand-yellow">
          This is a <b>placeholder</b> transcript. Real transcription runs
          automatically <b>in your browser</b> when you upload a video (no
          account, no install) — if you still see this, your browser blocked the
          model download; try re-importing on Chrome/Edge. Optional: set a free{" "}
          <b>GROQ_API_KEY</b> in a <b>.env</b> file for fast cloud transcription.
        </p>
      )}
